...
public class Customer {
	...
	public Customer(int wallet) {
		this.wallet = wallet; //호출 후 값 부여
		this.productArray = new Product[3];//Product 클래스를 가져와 할당.
	}
	
	//지출한다.
	public void pay(int price) {
		//만약 wallet - price값이 0보다 작으면 그 즉시 종료
	...
	public void addStock(String name, int price, int productCount) {
		...
		// 있다면, productCount만큼 수량만 증가시킨다. 없다면, 비어있는 인덱스를 찾아서 새롭게할당해준다.
